...
public class AntiBuild extends JavaPlugin implements Listener{
	...
	private void setConfigOptions() {
		...
		blacklistMessage = ChatColor.translateAlternateColorCodes('&', 
						   config.getString("Message-Blacklist", "You may not place or break this type of block!"));
		lockedWorldMessage = ChatColor.translateAlternateColorCodes('&',
				  			 config.getString("Message-Locked-World", "You are not allowed to build in this world!"));
